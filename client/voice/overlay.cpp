...
using PFN_D3DCreateDevice = HRESULT(WINAPI*)(IDirect3D9*, UINT, D3DDEVTYPE, HWND, DWORD, D3DPRESENT_PARAMETERS*, IDirect3DDevice9**);
PFN_D3DCreateDevice g_origD3DCreateDevice = nullptr;

std::atomic<bool> g_deviceHooksInstalled{false};

HRESULT WINAPI HookedD3DCreateDevice(IDirect3D9* d3d, UINT adapter, D3DDEVTYPE deviceType, HWND focusWindow, DWORD behaviorFlags, D3DPRESENT_PARAMETERS* pp, IDirect3DDevice9** returnedDevice) {
    HRESULT hr = g_origD3DCreateDevice(d3d, adapter, deviceType, focusWindow, behaviorFlags, pp, returnedDevice);
...
IDirect3D9* WINAPI HookedDirect3DCreate9(UINT SDKVersion) {
    ...
    if (d3d) {
        ...
        MH_STATUS s = MH_CreateHook(createDeviceAddr,
            reinterpret_cast<void*>(&HookedD3DCreateDevice),
